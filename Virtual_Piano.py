...
def draw_piano(frame):
    ...
    cv2.rectangle(frame, (x2, y2), (x2 + w, y2 + h), (0, 255, 255), -1)
    cv2.rectangle(frame, (x3, y3), (x3 + w, y3 + h), (255, 0, 255), -1)
    cv2.rectangle(frame, (x4, y4), (x4 + w, y4 + h), (255, 255, 0), -1)
    cv2.rectangle(frame, (x5, y5), (x5 + w, y5 + h), (255, 25, 255), -1)
    cv2.rectangle(frame, (x6, y6), (x6 + w, y6 + h), (215, 255, 25), -1)
    cv2.rectangle(frame, (x7, y7), (x7 + w, y7 + h), (25, 255, 55), -1)
    cv2.rectangle(frame, (x8, y8), (x8 + w, y8 + h), (55, 2, 255), -1)
